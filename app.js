    ...
    if (user) {
      ...
      Facebook.get('/' + req.user.id, function(err, results){
        ...
        //console.log(data);
          ...
          res.render('fbaccount', {fbaccount: imageArr, user: req.user, birthday: birthday, email: email, first_name: first_name});
          //console.log(res);
        }); //end GET /POSTS
...
res.render('facebook', {user: req.user, facebook: imageArr, birthday: birthday, email: email, first_name: first_name});
  ...
  query.findOne(function (err, user) {
    ...
    if (user) {
      ...
      Facebook.get('/' + req.user.id + "/likes", function(err, results){
        ...
        res.render('fblike', {user: req.user, fblike: likeArr, birthday: birthday, email: email, first_name: first_name});
      });
    });
   }});
});
